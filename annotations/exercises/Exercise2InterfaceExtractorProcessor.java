...
public class Exercise2InterfaceExtractorProcessor implements AnnotationProcessor {
    private final AnnotationProcessorEnvironment env;

    private ArrayList<MethodDeclaration> interfaceMethods =
            new ArrayList<MethodDeclaration>();

    public Exercise2InterfaceExtractorProcessor(AnnotationProcessorEnvironment env) {
        this.env = env;
    }
