...
public class Exercise11 {
    ...
    @Test
    @TestNote11("___testNote__annotation_test__")
    void testingNotes() {
        print("Before this test should be annotation message");
    }

    public static void main(String[] args) throws Exception {
        AtUnit.main(new String[]{"Exercise11"});
    }

    static class AtUnit implements ProcessFiles.Strategy {
        ...
        private void printTestNotesFor(Method m) {
            TestNote11 note = m.getAnnotation(TestNote11.class);
            if (null != note) {
                print(note.value());
            }
        }
